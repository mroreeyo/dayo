...
import { CreateEventDto, EventsQueryDto, ListEventsResponseDto, UpdateEventDto } from './events.dto';
...
export class EventsController {
  ...
  @Patch('/:id')
  update(@CurrentUser() user: RequestUser, @Param('id') eventId: string, @Body() dto: UpdateEventDto) {
